...
public class FileBrowser {
    ...
    public static AlertDialog createFileBrowser(Context ctx, final OnFileSelectedListener listener) {
        ...
        final FileFilter filter = pathname -> pathname.isDirectory() || (pathname.isFile() && pathname.getName().endsWith(".m3u"));
        ...
        final OnItemClickListener onItemClickListener = (parent, view, position, id) -> {
